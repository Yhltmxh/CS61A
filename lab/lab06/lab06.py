...
class Account:
    ...
    def transactionRecord(self, before, after):
        self.transactions.append(Transaction(self.id, before, after))
        self.id += 1
    ...
    def deposit(self, amount):
        ...
        self.transactionRecord(self.balance - amount, self.balance)
        return self.balance
    ...
    def withdraw(self, amount):
        ...
        if amount > self.balance:
            self.transactionRecord(self.balance, self.balance)
...
class ChangeMachine:
    ...
    def change(self, coin):
        ...
        if res == None: return [coin]
        for x in res:
            self.coins = remove_one(self.coins, x)
        if coin in self.coins: self.coins[coin] += 1
